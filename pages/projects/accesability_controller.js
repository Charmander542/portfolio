        ...
        <video autoPlay loop muted playsInline className="absolute z-0 w-full h-full object-cover">
          ...
          <section className="py-8 bg-gray-100">
            <div className="text-left">
              ...
              of sensors, such as touch, vibration, sound, sliders and others, to cater to the nuanced needs of individuals with 
              ...
              also takes into account the need for easy installation and removal of sensors, facilitating maintenance and upgrades.</p>
            </div>
            ...
            Controlling the board is an RP240 chip with the TinyUSB library running on it, which configures the device as a 
            ...
            connection and disconnection of the HID device, alongside functions for processing gamepad data, which 
            is crucial for interpreting inputs like joystick movements and button presses.
            </p>
            </div>
          ...
          <section className="py-8">
            <div className="text-left">
              ...
              accessibility controller. To address this, I designed a custom part, made to fit onto the controller. The mount had various screw holes for any shape of board to be attached. 
              The 3D printed component ensured that each sensor was accurately positioned for optimal 
              functionality.
              </p>
              <p className="text-[1.3rem] font-medium mb-4">
              Another significant challenge involved the development of a custom USB controller interface. 
              The controller needed to perform two USB tasks: one for sending data from the sensors to the processing unit, 
              and another for receiving input commands. Sadly the RP240 only has one USB controller so to get arroung this I wrote a bit-banged USB controller. This custom 
